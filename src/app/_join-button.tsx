...
export function JoinButton() {
  return (
    <a
      ...
      target="_blank"
      className="group fixed bottom-6 sm:bottom-10 left-1/2 z-50 flex -translate-x-1/2 items-center justify-center rounded-full bg-white/80 backdrop-blur-sm px-4 py-1.5 shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f]"
    >
      <span
        className={cn(
